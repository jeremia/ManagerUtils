...
public class Loc  {
     ...
     */    
    //private static final String messagesBundle = "/jeremiaMorling/seTaskManagerPro/messages.properties";
    ...
    public Loc( String messagesBundle ) {
        initLocalizationSupport( System.getProperty( "microedition.locale" ), messagesBundle );
    }
     ...
     */        
    /*private boolean initLocalizationSupport( String messagesBundle ) {
        return initLocalizationSupport( System.getProperty( "microedition.locale" ), messagesBundle );     // NOI18N
    }*/
     ...
     * @return true if the intialization was succesfull, false if there was any problem.
     */    
    private boolean initLocalizationSupport( String locale, String messagesBundle ) {
        InputStream in = null;
        ...
        try {         
            ...
            if ((locale != null) && (locale.length() > 1)) {
                int lastIndex = messagesBundle.lastIndexOf('.');
                String prefix = messagesBundle.substring(0,lastIndex);
                String suffix = messagesBundle.substring(lastIndex);
            ...
            if (in == null) {
                ...
                in = clazz.getResourceAsStream(messagesBundle);
            }                      
            if (in == null) {
     ...
     * is returned
     */    
    public String internalGetText(String key) {
     ...
     * is returned
     */    
    private final String getMessage(String key, Object[] args) {
     ...
     */    
    private synchronized void _loadMessages(InputStream inStream) throws IOException {
